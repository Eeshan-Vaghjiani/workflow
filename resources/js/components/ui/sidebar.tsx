...
function SidebarRail({ className, ...props }: React.ComponentProps<"div">) {
    return (
        <div
            ...
            data-sidebar="rail"
            className={cn(
                "bg-sidebar border-sidebar-border flex h-full w-14 flex-col items-center border-r",
                className
            )}
            {...props}
        />
...
type SidebarGroupActionProps = React.ComponentProps<"div"> & {
    asChild?: boolean
}

const SidebarGroupAction = React.forwardRef<HTMLDivElement, SidebarGroupActionProps>(
