...
export default function Invite({ group, errors }: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        },
        {
            ...
            href: `/groups/${group.id}/members/invite`,
        },
    ];
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="mb-6">
                                ...
                                <div className="mb-4">
                                    ...
                                    <select
                                        id="role"
                                        className="w-full px-3 py-2 border rounded-md shadow-sm focus:ring focus:ring-opacity-50 border-gray-300 focus:ring-blue-200 focus:border-blue-500"
                                        value={data.role}
