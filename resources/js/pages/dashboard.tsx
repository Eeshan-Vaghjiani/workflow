...
import { Calendar, CheckSquare, Clock, GitBranch, Users, ListTodo } from 'lucide-react';
...
export default function Dashboard({ groups, assignments, tasks, unreadNotificationsCount }: Props) {
